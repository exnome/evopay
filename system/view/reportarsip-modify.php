																...
																<div class="form-group">
																    <div class="col-sm-3">
																        ...
																        $sql = "select jns_pph,tarif_persen,(jns_pph+'#'+convert(varchar,tarif_persen)) val 
															        		from settingPph where npwp = '".$is_ppn."' order by idpph asc";
																		$rsl = mssql_query($sql);
									...
									?>
									   ...
									   ?>     
										...
										?>
                                            ...
                                            <?php } ?>
                                          <!--  <div class="form-group">
                                                <label class="col-sm-2 control-label">Dept. Head Finance</label> 
                                                <div class="col-sm-1">User :  </div>
                                                <div class="col-sm-4">
                                                        <?php $note_arr = usernote($vw['nobukti'],'DEPT. HEAD','FINANCE, ADMINISTRATION & SYSTEM TECHNOLOGY','FINANCE'); 
                                                        echo $note_arr["user"]; ?>
                                                </div>
                                               <div class="col-sm-1">Waktu : </div>
                                                <div class="col-sm-4"><?php	echo $note_arr["tgl"]; ?></div>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Note</label> 
												<div class="col-sm-10">
													<input type="text" class="form-control" id="note_dept_head_fin" <?php note($vw['nobukti'],'DEPT. HEAD','FINANCE, ADMINISTRATION & SYSTEM TECHNOLOGY','FINANCE'); ?> >
												</div>
											</div>-->
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Dept.Head Finance / Div.Head FAST</label> 
                                                <div class="col-sm-1">User : </div>
                                                <div class="col-sm-4">
...
<?php
	function note($nobukti,$level,$div,$dept){
		...
		$note = mssql_fetch_array(mssql_query("select ketvalidasi as note, ketreject, validasi from DataEvoVal where nobukti = '".$nobukti."' and level = '$level'
					and isnull(deptterkait,'') = '' "));
		if ($note['validasi']=='Reject') {
			echo 'value="'.$note['ketreject'].' " readonly';
		} else {			
			echo 'value="'.$note['note'].' " readonly';
		}
	}
