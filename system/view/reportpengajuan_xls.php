<?php
	...
	$objPHPExcel->getProperties()->setTitle("Report Pengajuan Evopay");
	$objPHPExcel->getProperties()->setSubject("Report Pengajuan Evopay");
	$objPHPExcel->getProperties()->setDescription("Report Pengajuan Evopay");
	...
	$objPHPExcel->getActiveSheet()->setTitle('Report Pengajuan Evopay');
	...
	$tgl = date("Ymd_His");
	$filename = "report_pengajuan_".$tgl;
